                ...
                <div className="flex items-center gap-[25px] 3xl:gap-[15px]">
                    <div
                        className={`flex items-center justify-center w-[70px] 3xl:w-[50px] h-[70px] 3xl:h-[50px] ${
                            circleIcon
                                ? `bg-${type} text-white rounded-full`
                                : `bg-${type}-transparent text-${type} rounded-[14px]`
                        }`}
                    >
                        <ReactSVG
                            src={require(`/nextjs-mbs/img/icon/${icon}`)}
                    ...
                    <div className="flex items-start gap-[25px] 3xl:gap-[15px]">
                        <div>
                            ...
                            <span className="text-body dark:text-white/60 text-base">
                                {label}
                            </span>
                        </div>
                        <span
