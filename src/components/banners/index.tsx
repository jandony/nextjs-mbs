        ...
        <div className="mb-[72px]">
            <div className="relative bg-white dark:bg-white/10 min-h-[270px] pt-10 px-[30px] pb-[70px] rounded-[10px]">
                ...
                <Buttons
                    size="small"
                    type="primary"
                    className="h-9 bg-transparent px-5 text-primary border-primary"
                >
                    Start
                </Buttons>
            </div>
        ...
        <div className="mb-[72px]">
            <div className="relative bg-[#5f63f2] min-h-[270px] pt-10 px-[30px] pb-[70px] rounded-[10px]">
                <div>
                    ...
                    />
                    <figcaption>
                        <h2 className="mb-3 text-2xl font-semibold text-white dark:text-white/[.87]">
            ...
            <div className="relative bg-white dark:bg-white/10 min-h-[270px] pt-10 px-[30px] sm:px-[15px] pb-[70px] rounded-[10px]">
                <div className="flex items-center gap-4 sm:flex-col mb-0">
                    ...
                    <figcaption className="sm:text-center">
                        <h2 className="mb-2.5 text-dark dark:text-white/[.87] text-2xl font-semibold">
...
function Banner8() {
    return (
        <div className="relative bg-dark dark:bg-white/10 min-h-[360px] p-[25px] rounded-[10px]">
            ...
            />
            <figcaption>
                <h2 className="mb-3 text-3xl font-bold text-white dark:text-white/[.87]">
                    Congratulations Jhon!
                </h2>
                <p className="mb-4 font-normal text-white dark:text-white/[.87] opacity-70 text-15">
                    Best Seller on the last month.
...
function BannerCarousel() {
    return (
        <div className="relative pb-16 mb-8 bg-primary pt-14 rounded-10 max-w-[550px] lg:max-w-[calc(100vw-30px)]">
            <Carousel
                autoplay
                className="[&>.slick-dots.slick-dots-bottom]:-bottom-2.5 [&>.slick-dots>li]:w-auto [&>.slick-dots>li>button]:w-[5px] [&>.slick-dots>li>button]:h-[5px] [&>.slick-dots>li>button]:m-0 [&>.slick-dots>li>button]:rounded-full"
            >
                <div className="flex flex-col items-center justify-center px-5">
                    ...
                    <div className="text-center mt-7 px-3">
                        <h3 className="mb-2 text-2xl font-semibold text-white dark:text-white/[.87]">
                            Achievements
                        </h3>
    ...
    return (
        <div className="mb-8">
            <div className="px-5 py-8 text-center bg-white dark:bg-white/10 rounded-10">
                <h2 className="font-semibold mb-7 text-dark dark:text-white/[.87] text-22">
                    Up To Date{' '}
                </h2>
                <Image
                    className="mx-auto"
...
function PageHeaderBanner({ type, title, subtitle }: PageHeaderBannerProps) {
    return (
        <div
            className={
                type === 'corporate'
                    ? 'bg-white dark:bg-white/10 rounded-10'
                    : 'bg-white dark:bg-white/10 rounded-10'
            }
        >
            <div>
                <Row gutter={25} className="items-center">
                    <Col xs={24} sm={24} md={24} lg={24} xl={10}>
                        <figcaption className="p-[40px] ssm:px-[25px]">
                            ...
                            <p className="text-dark dark:text-white/[.87] text-[16px] mb-[25px]">
                                {subtitle}
                            </p>
                            <Buttons
                                size="large"
