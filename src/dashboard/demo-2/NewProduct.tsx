    ...
    if (newProduct !== null) {
        newProduct[productTab as keyof productData].map((value: Product) => {
            ...
            return newProductData.push({
                    ...
                    <div className="flex items-center">
                        <div className="ltr:mr-2.5 rtl:ml-2.5 w-[34px] h-[34px]">
                            <Image
                                ...
                                src={`/nextjs-mbs/img/products/electronics/${img}`}
                                alt="Product"
                                width="34"
                                height="34"
                            />
                ...
                price: (
                    <span className="font-medium text-[14px] text-dark dark:text-white/[.87]">
                        {price}
                    </span>
                ),
            })
