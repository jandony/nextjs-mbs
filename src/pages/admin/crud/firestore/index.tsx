      ...
      return dataSource.push({
        ...
        action: (
          <div className="min-w-[150px] text-end -m-2">
            <Link className="inline-block m-2" href={`/admin/crud/firestore/edit/${id}`}>
              <UilEdit className="w-4 text-light-extra dark:text-white60" />
            </Link>
            <Link className="inline-block m-2" href="#">
              <UilTrash href="#" onClick={() => handleDelete(id)} className="w-4 text-light-extra dark:text-white60" />
            </Link>
          </div>
        ),
      });
