            ...
            <div className="bg-white dark:bg-white/10 rounded-[10px]">
                <div className="bg-white dark:bg-white/10 px-[25px] pt-[30px] pb-[18px] rounded-[10px] text-center">
                    <figure className="relative max-w-[120px] mx-auto mb-6">
                        <Image className="mx-auto rounded-full" src={tempUser?.image} alt="" width="120" height="120" />
                    ...
                    <figcaption>
                        ...
                        <p className="mb-0 text-light dark:text-white/60 text-15">{tempUser?.role}</p>
                    </figcaption>
                </div>
