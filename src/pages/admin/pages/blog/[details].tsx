...
function BlogDetails() {
    ...
    const post: BlogPost | undefined = BlogCardData.find(
        (item) => item.slug === slug
    )
                                ...
                                <div className="px-24 3xl:px-14 2xl:px-[30px] xl:px-0">
                                    <div>
                                        ...
                                        <p className="text-lg text-body dark:text-white/60">
                                            ...
                                            activities. Good time management
                                            enables you to work smarter – not
                                            harder – so that you get more done
                                            in less time, even when time is
                                            tight and pressures are high.
                                            Failing to manage your time damages
                                            your effectiveness and causes
                                            stress.
                                        </p>
                                        <p className="text-lg text-body dark:text-white/60">
                                            ”Time management” is the process of
                                        ...
                                        <blockquote className="mb-1">
                                            <div className="relative max-w-[630px] ltr:pl-10 rtl:pr-10 before:absolute before:h-full before:w-0.5 ltr:before:left-2 rtl:before:right-2 before:top-0  before:bg-primary before:opacity-30">
                                                <p className="relative text-xl ltr:pl-5 rtl:pr-5 text-dark dark:text-white/[.87]">
                                                    ...
                                                    improve the usability of a
                                                    product, which is an
                                                    important part to guide the
                                                    actual design. It can also
                                                    be regarded. A month ago, I
                                                    agreed to
                                                    <img
                                    ...
                                    <div className="flex items-start gap-5 mt-12 bg-white rounded-lg sm:flex-col dark:bg-white/10 p-9 shadow-custom dark:shadow-none">
                                        ...
                                        <div>
                                            <span className="text-body dark:text-white/60 text-15">
                                                Written By
                                            </span>
                                            <span className="block text-lg font-semibold text-dark dark:text-white/[.87]">
                                                Charli Day
                                            </span>
                                            <p className="mt-5 mb-0 text-base text-light dark:text-white/60">
                                                Charli Day is a British writer
                                                and social media manager
                                                specializing in dynamic
                                                branding, campaign strategy and
                                                content engagement.{' '}
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    >
                                        <span className="text-base font-semibold text-breadcrumbs dark:text-white/[.87]">
                                            Share
                                        </span>
                                        <ul>
                                            <li className="my-2.5">
