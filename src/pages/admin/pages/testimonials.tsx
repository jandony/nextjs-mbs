                        ...
                        <Swiper {...paramsOne} className="px-5 pt-10 pb-[60px]">
                            {users.map((user: User, index: number) => {
                                return (
                                    <SwiperSlide
                                        key={index + 1}
                                        className="p-10 text-center bg-white rounded-lg sm:px-5 dark:bg-white/10 shadow-[0_10px_20px_rgba(116,116,116,0.06)] dark:shadow-none"
                                    >
                                        <figure className="mb-0">
                                            ...
                                            />
                                            <figcaption>
                                                <h2 className="mb-1 font-medium text-dark dark:text-white/[.87] text-15">
                                                    {user.name}
                                                </h2>
                                                ...
                                                <div className="mx-auto text-center max-w-[770px]">
                                                    <div className="testimonial-block__review">
                                                        <p className="mb-1 text-base leading-7 text-body dark:text-white/60">
                                                            ...
                                                            readable will page
                                                            when looking at its
                                                            was layout will page
                                                            when looking.
                                                        </p>
                                                    </div>
                                                    <div className="">
                                                        <div className="mt-2">
                                                            <h2 className="mb-1 text-base font-medium text-dark dark:text-white/[.87]">
                                                                {user.name}
                                                            </h2>
