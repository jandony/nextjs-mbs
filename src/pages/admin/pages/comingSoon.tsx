        ...
        return (
            <div className="flex justify-center gap-x-[50px] sm:gap-x-5">
                <span>
                    ...
                    <span className="block text-body dark:text-white/60 text-base sm:text-[15px]">
                        Days
                    </span>
                </span>
                <span>
                    ...
                    <Col sm={24} xs={24}>
                        <div className="bg-white dark:bg-white/10 pt-[90px] pb-20 px-[15px] sm:py-10 text-center rounded-10">
                            ...
                            <p className="max-w-[58px]0 mx-auto text-body dark:text-white/60 mb-6 text-[17px] md:text-base sm:text-[15px]">
                                ...
                                and typesetting industry`s standard dummy text
                            ...
                            <div className="mt-10 xl:mt-8 lg:mt-6 mb-16 xl:mb-10 lg:mb-5">
                                <Form name="basic">
                                    <div className="flex justify-center xs:flex-col gap-x-5">
                                        ...
                                        >
                                            <Input
                                                className="h-12 min-w-[320px] md:min-w-full px-5 py-3 placeholder:dark:text-white/60"
                            ...
                            <ul className="flex justify-center mb-7">
                                <li className="ltr:mr-4 rtl:ml-4">
                                    <Link
                                        href="#"
                                        className="flex justify-center items-center bg-facebook w-11 h-11 rounded-full"
                                    >
                                        <FontAwesome
                                            name="facebook"
                                ...
                                <li className="ltr:mr-4 rtl:ml-4">
                                    <Link
                                        href="#"
                                        className="flex justify-center items-center bg-twitter w-11 h-11 rounded-full"
                                    >
                                        <FontAwesome
                                            name="twitter"
                                            className="text-white"
                                ...
                                <li className="ltr:mr-4 rtl:ml-4">
                                    <Link
                                        href="#"
                                        className="flex justify-center items-center bg-red-500 w-11 h-11 rounded-full"
                                    >
                                        <FontAwesome
                                            name="globe"
                                            className="text-white"
                                ...
                                <li className="ltr:mr-4 rtl:ml-4">
                                    <Link
                                        href="#"
                                        className="flex justify-center items-center bg-github w-11 h-11 rounded-full"
                                    >
                                        <FontAwesome
                                            name="github"
                                            className="text-white"
                            ...
                            <p className="text-body dark:text-white/60 mb-0">
                                2024 © Sovware
                            </p>
                        </div>
                    </Col>
