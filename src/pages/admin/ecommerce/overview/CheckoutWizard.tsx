            ...
            return dataSource.push({
                        ...
                        <div className="flex items-center gap-x-[25px]">
                            ...
                            <figcaption>
                                <div>
                                    <Heading
                                        as="h6"
                                        className="mb-2 text-base font-medium text-dark dark:text-white/[.87]"
                                    >
                                        {name}
                                    </Heading>
                ...
                quantity: (
                    <div className="flex items-center gap-x-4">
                        <Buttons
                            onClick={() =>
                                decrementUpdate(id, Number(quantity))
                            }
                        ...
                        <Buttons
                            onClick={() =>
                                incrementUpdate(id, Number(quantity))
                            }
                            className="flex items-center justify-center bg-section dark:bg-white/10 w-9 h-9 p-0 text-body dark:text-white/60 border-none rounded-[10px]"
                            type="default"
                        >
                            ...
                            <div className="w-[580px] sm:px-[25px]">
                                <Row justify="center">
                                    <Col sm={22} xs={24}>
                                        <Heading
                                            as="h4"
                                            className="mb-[38px] text-xl md:text-lg ssm:text-base font-semibold"
                                        >
                                        ...
                                        <Form form={form} name="account">
                                            ...
                                            >
                                                <Input
                                                    ...
                                                    className="h-12 p-3 dark:placeholder-white/60"
                                                />
                                            </Form.Item>
                                            <Form.Item
                                                className="mb-6 [&>.ant-row>.ant-col]:flex-1 [&>.ant-form-item-row>div>div>div>input]:border-normal dark:[&>.ant-form-item-row>div>div>div>input]:border-white/10 dark:[&>.ant-form-item-row>div>div>div>input]:bg-[#282b36] [&>.ant-form-item-row>div>div>div>input]:rounded-4 dark:[&>.ant-form-item-row>div>div>div>input]:text-white/60 [&>.ant-form-item-row]:flex-col [&>div>.ant-form-item-label]:text-start dark:[&>.ant-form-item-row>div>label]:text-white/60"
                                            ...
                                            >
                                                <Input.Password
                                                    ...
                                                    className="px-2 hover:border-primary"
                                                />
                                            </Form.Item>
                                                            ...
                                                            >
                                                                ...
                                                                >
                                                                    <div className="flex items-center flex-wrap gap-[10px]">
                                                                        <Input
                                                                            className="max-w-[120px] h-12 p-3 dark:placeholder-white/60"
                                                                            placeholder="XXX"
                                                                        />
                                                                        <Link
                                                                            className="text-dark dark:text-white/60"
                                                                            href="#"
                                                                        >
                                                                            What
                                                                            is
                                            ...
                                            <div className="bg-regularBG dark:bg-whiteDark mb-[25px] p-[25px] ssm:px-[15px] rounded-[15px]">
                                                <div>
                                                    ...
                                                    >
                                                        ...
                                                        <Link
                                                            href="#"
                                                            className="inline-flex items-center gap-x-[5px] text-sm"
                                                        >
                                                ...
                                                <article>
                                                    ...
                                                    >
                                                        <Radio
                                                            ...
                                                            className="[&>.ant-radio]:self-start [&>.ant-radio]:top-1 [&>.ant-radio>.ant-radio-inner]:hover:border-primary [&>.ant-radio-checked>.ant-radio-inner]:bg-primary [&>.ant-radio-checked>.ant-radio-inner]:border-primary"
                                                        >
                                                            <div className="mx-3">
                                                                <Heading
                                                                    as="h6"
                                                    ...
                                                    <Link
                                                        className="text-info hover:text-primary text-[13px] font-medium"
                                                        href="#"
                                                    >
                                                        + Add New Address
                                                    </Link>
                                                    ...
                                                    >
                                                        <div className="invoice-summary-inner">
                                                            ...
                                                            <Heading
                                                                ...
                                                                as="h4"
                                                            >
                                                                <span className="text-base font-medium text-dark dark:text-white/[.87]">
                                                                    Total :{' '}
                                                                </span>
