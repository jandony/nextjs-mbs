import { UilImport, UilMessage, UilPrint } from '@iconscout/react-unicons'
            ...
            details: (
                <>
                    <div className="min-w-[300px]">
                        <Heading
                            className="text-dark dark:text-white/[.87] text-[15px] font-medium"
                            as="h6"
                        >
                            Fiber Base Chair
                        </Heading>
                    ...
                    <Col md={24}>
                        <div className="bg-white dark:bg-white/10 p-[25px] rounded-10">
                            ...
                            <div className="flex items-center justify-around flex-wrap gap-[20px] bg-regularBG dark:bg-regularBGdark pt-[30px] px-[50px] pb-[25px] rounded-[20px]">
                                <article>
                                    <Heading
                                        className="mb-2 text-4xl font-semibold text-dark dark:text-white/[.87]"
                                        as="h3"
                                    >
                                        Invoice
                                    </Heading>
                                    <p className="mb-1 text-body dark:text-white/60 text-[15px] font-medium">
                                        No : #642678
                                    </p>
                                    <p className="mb-1 text-body dark:text-white/60 text-[15px] font-medium">
                                        Date : Jan 17, 2020
                                ...
                                <div className="max-w-[310px] mx-auto text-center border dark:border-white/10 rounded-[10px]">
                                    <div className="bg-white dark:bg-white/10 p-[25px] rounded-[10px]">
                                        ...
                                        <p className="mb-0 text-theme-gray dark:text-white/60">
                                            8364297359912267
                                        </p>
                                    </div>
                                </div>
                                <address className="text-end sm:text-center">
                                    <Heading
                                        className="mb-[5px] text-dark dark:text-white/[.87] text-[15px] font-medium uppercase"
                                        as="h5"
                                    >
                                        Invoice To:
                                    </Heading>
                            ...
                            <Row justify="end">
                                ...
                                >
                                    <div className="max-w-[650px] mx-auto">
                                        ...
                                        <Heading
                                            className="flex items-center justify-between w-full text-[15px]"
                                            as="h4"
                                        >
